  ...
  if (stats.total_races_run === 0) {
    return (
      <div className="flex min-h-svh flex-col items-center justify-center gap-6 px-6 text-center">
        ...
        <p className="text-foreground/60">Run some races to build the Hall of Fame.</p>
              ...
              {stats.animals.map((animal, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right text-foreground/60">{animal.total_races}</td>
                    <td className="px-4 py-3 text-right text-foreground/60">{animal.wins}</td>
                    <td className="px-4 py-3 text-right text-foreground/60">{animal.losses}</td>
